...
export const EventCheckin = () => {
  ...
  const handleEndCheckin = async () => {
    if (!eventId) return;
    if (!window.confirm('Bạn có chắc chắn muốn kết thúc điểm danh? Thao tác này sẽ đóng cổng điểm danh và cập nhật trạng thái vắng mặt cho những người chưa đến.')) return;
