  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="relative mb-24">
        <div className="h-48 md:h-64 w-full bg-blue-600 rounded-[40px] overflow-hidden shadow-lg relative">
          {club.cover_url ? (
            <img src={club.cover_url} className="w-full h-full object-cover" alt="Cover" referrerPolicy="no-referrer" />
          ) : (
            <div className="w-full h-full bg-gradient-to-br from-blue-600 to-indigo-700 opacity-50" />
          )}
          <button 
            onClick={() => navigate(-1)}
        ...
        <div className="absolute -bottom-16 left-8 flex flex-col md:flex-row md:items-end md:space-x-6 w-full px-4 md:px-0">
          ...
          <div className="flex items-center space-x-3 mt-6 md:mt-0 md:pb-4 md:pr-8">
            <Button 
              ...
              className={`rounded-2xl px-8 py-3 font-bold shadow-lg ${isFollowing ? 'border-gray-200' : 'shadow-blue-100'}`}
            ...
            <button className="p-3 bg-gray-100 rounded-2xl text-gray-500 hover:bg-gray-200 transition-all">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex space-x-1 bg-gray-100 p-1 rounded-2xl">
            <button 
              ...
              className={`flex-1 flex items-center justify-center space-x-2 py-3 rounded-xl text-sm font-bold transition-all ${activeTab === 'posts' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
            >
            ...
            <button 
              ...
              className={`flex-1 flex items-center justify-center space-x-2 py-3 rounded-xl text-sm font-bold transition-all ${activeTab === 'events' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
            >
                  ...
                  events.map(event => (
                    ...
                    >
                      <div className="flex space-x-4">
                        <div className="h-20 w-20 bg-blue-50 rounded-xl overflow-hidden flex-shrink-0">
                          {event.cover_url ? (
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-bold text-gray-900 group-hover:text-blue-600 transition-colors truncate">{event.title}</h4>
